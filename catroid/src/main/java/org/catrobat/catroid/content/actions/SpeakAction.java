...
public class SpeakAction extends TemporalAction {
	...
	private boolean determineLengthOfText = false;
	...
	public void setDetermineLengthOfText(boolean getDurationOfText) {
		this.determineLengthOfText = getDurationOfText;
	}
}
