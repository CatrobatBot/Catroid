...
public class MergeTask {
	...
	public MergeTask(Project firstProject, Project secondProject, Context context) {
	...
	public boolean mergeProjects(String name) {
		mergedProject = new Project(context, name);
	...
	public boolean mergeScenes(String sceneName) {
		...
		ConflictHelper.renameConflicts(mergeResult, context.getString(R.string.global));
