...
public class Job {
	...
	public Job(long jobID, String title, WebImage image) {
		...
		this.image = image;
		this.progress = 0;
		this.downloadState = DownloadState.NOT_YET_DOWNLOADED;
	...
	public static Job fromJson(JSONObject data) throws JSONException {
		...
		job.downloadState = alreadyDownloaded ? DownloadState.ALREADY_DOWNLOADED : DownloadState.NOT_YET_DOWNLOADED;
