...
public final class ExpiringLruMemoryObjectCache<V> extends ExpiringLruMemoryCache<String, V> {
    ...
    private static final long EXPIRE_TIME = Constants.MEMORY_OBJECT_CACHE_EXPIRE_TIME;
    private static final int CACHE_SIZE = Constants.MEMORY_OBJECT_CACHE_MAX_SIZE;
