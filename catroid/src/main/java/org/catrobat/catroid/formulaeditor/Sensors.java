...
public enum Sensors {
	X_ACCELERATION, Y_ACCELERATION, Z_ACCELERATION, COMPASS_DIRECTION,  LATITUDE, LONGITUDE,
	LOCATION_ACCURACY, ALTITUDE, X_INCLINATION, Y_INCLINATION, LOUDNESS,
	FACE_DETECTED, FACE_SIZE, FACE_X_POSITION, FACE_Y_POSITION, OBJECT_X(true), OBJECT_Y(true),
	OBJECT_TRANSPARENCY(true), OBJECT_BRIGHTNESS(true), OBJECT_COLOR(true), OBJECT_SIZE(true), OBJECT_ROTATION(true), OBJECT_LAYER(true),
	...
	DRONE_RECORDING, DRONE_NUM_FRAMES, OBJECT_X_VELOCITY(true), OBJECT_Y_VELOCITY(true), OBJECT_ANGULAR_VELOCITY(true),
	LAST_FINGER_INDEX, FINGER_X, FINGER_Y, FINGER_TOUCHED,
	NFC_TAG_ID;
