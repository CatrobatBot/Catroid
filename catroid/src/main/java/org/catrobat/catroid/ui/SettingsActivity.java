...
public class SettingsActivity extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!BuildConfig.SNACKBAR_HINTS_ENABLED) {
			CheckBoxPreference snackbarPreference = (CheckBoxPreference) findPreference(SETTINGS_SHOW_HINTS);
			snackbarPreference.setChecked(false);
		}
	}
