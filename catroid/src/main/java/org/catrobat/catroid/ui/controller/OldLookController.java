...
public final class OldLookController {
	...
	private static final String TAG = OldLookController.class.getSimpleName();
	private static final OldLookController INSTANCE = new OldLookController();

	private OnBackpackLookCompleteListener onBackpackLookCompleteListener;

	private OldLookController() {
	}

	public static OldLookController getInstance() {
		return INSTANCE;
	}

	public void updateLookLogic(final int position, final LookViewHolder holder, final LookListAdapter lookAdapter) {
	}

	private void handleDetails(LookData lookData, LookViewHolder holder, LookListAdapter lookAdapter) {
	...
	public LookData updateLookBackPackAfterUnpacking(LookData lookData, LookListAdapter adapter, String name, boolean
...
//		}
	...
	public void deleteCheckedLooks(LookListAdapter adapter, List<LookData> lookDataList, Activity activity) {
