...
public class BackPackLookListFragment extends BackPackActivityFragment implements CheckBoxListAdapter
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null) {
			lookToEdit = (LookData) savedInstanceState.getSerializable(OldLookController.BUNDLE_ARGUMENTS_SELECTED_LOOK);
		}
	...
	public void onSaveInstanceState(Bundle outState) {
		outState.putSerializable(OldLookController.BUNDLE_ARGUMENTS_SELECTED_LOOK, lookToEdit);
	...
	public void onResume() {
		super.onResume();
		loadShowDetailsPreferences(OldLookController.SHARED_PREFERENCE_NAME);
	}
	...
	public void onPause() {
		super.onPause();
		saveCurrentProject();
		putShowDetailsPreferences(OldLookController.SHARED_PREFERENCE_NAME);
	}
	...
	private void unpackLook() {
		OldLookController.getInstance().unpack(lookToEdit, false, false);
	}
}
