...
public class StartScriptTest extends AndroidTestCase {
	...
	public void testStartScript() throws InterruptedException {
		...
		startScript.addBrick(new HideBrick());
		...
		assertFalse("Look is not hidden", sprite.look.isLookVisible());
		assertEquals("the size is not as expected", size, sprite.look.getSizeInUserInterfaceDimensionUnit());
	}
}
