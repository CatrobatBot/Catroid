...
public class CatroidFieldKeySorterTest extends AndroidTestCase {
	...
	public void testGetFieldName() {
		...
		String fieldKeyName = CatroidFieldKeySorter.getAliasOrFieldName(fieldKey);

		assertEquals("b", fieldKeyName);
	}

	public void testGetAliasFieldName() {
		FieldKey fieldKeyWithAlias = new FieldKey("a", SortAlphabeticallyWithAliases.class, 0);
		String fieldKeyAlias = CatroidFieldKeySorter.getAliasOrFieldName(fieldKeyWithAlias);

		assertEquals("x", fieldKeyAlias);
	}
