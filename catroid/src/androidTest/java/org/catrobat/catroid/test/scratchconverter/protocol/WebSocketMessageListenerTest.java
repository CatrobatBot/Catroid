...
public class WebSocketMessageListenerTest extends AndroidTestCase {
	...
	protected void setUp() throws Exception {
		...
		// access private map by using introspection
		Field field = WebSocketMessageListener.class.getDeclaredField("jobHandlers");
		field.setAccessible(true);

		// add job handler to map
		Map<Long, JobHandler> jobHandlers = (Map<Long, JobHandler>) field.get(webSocketMessageListener);
