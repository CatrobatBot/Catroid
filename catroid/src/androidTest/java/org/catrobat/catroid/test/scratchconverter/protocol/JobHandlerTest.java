...
public class JobHandlerTest extends AndroidTestCase {
	...
	public void testReceivedOnDownloadStartedEvent() {
		...
		expectedJob.setState(Job.State.RUNNING);
		expectedJob.setDownloadState(Job.DownloadState.NOT_YET_DOWNLOADED);
	...
	public void testReceivedOnDownloadFinishedEvent() {
		...
		assertEquals("Expecting downloadState to be ALREADY_DOWNLOADED after onDownloadFinished() called",
				Job.DownloadState.ALREADY_DOWNLOADED, expectedJob.getDownloadState());
	...
	public void testReceivedOnUserCanceledDownloadEvent() {
		...
		assertEquals("Expecting downloadState to be NOT_YET_DOWNLOADED after onUserCanceledDownload() called",
				Job.DownloadState.NOT_YET_DOWNLOADED, expectedJob.getDownloadState());
