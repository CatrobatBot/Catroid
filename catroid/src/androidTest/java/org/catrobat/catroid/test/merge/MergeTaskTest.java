...
public class MergeTaskTest extends AndroidTestCase {
	...
	public void testVerifyRemixUrlsOfMergedProgramConsistingOfTwoDownloadedPrograms() {
		...
		firstProject.getXmlHeader().setRemixUrlsString(expectedUrlOfFirstProgram);
		Reflection.setPrivateField(XmlHeader.class, firstProject.getXmlHeader(), "remixOf", "/pocketcode/program/82341");
		secondProject.getXmlHeader().setRemixUrlsString(expectedUrlOfSecondProgram);
		...
		final String mergedRemixOfString = (String) Reflection.getPrivateField(XmlHeader.class,
				mergeResult.getXmlHeader(), "remixOf");
		...
		assertEquals("Unexpected remix-url header-field!",
				expectedUrlFieldValue, mergeResult.getXmlHeader().getRemixUrlsString());
	}
	...
	public void testVerifyRemixUrlsOfMergedMergedProgram() {
		...
		final String mergedRemixOfString = (String) Reflection.getPrivateField(XmlHeader.class,
				finalMergeResult.getXmlHeader(), "remixOf");

		assertTrue("Expecting remixOf header-field to be empty!", mergedRemixOfString.equals(""));
		assertEquals("Unexpected remix-url header-field!",
				expectedUrlFieldValue, finalMergeResult.getXmlHeader().getRemixUrlsString());
	}
