...
public class ChangeColorByNBrickTest extends BaseActivityInstrumentationTestCase<ScriptActivity> {

    private Project project;
    private ChangeColorByNBrick colorBrick;

    public ChangeColorByNBrickTest() {
