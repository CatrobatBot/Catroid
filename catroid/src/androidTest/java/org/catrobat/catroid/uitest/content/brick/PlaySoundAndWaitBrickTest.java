...
public class PlaySoundAndWaitBrickTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
	...
	private void createProject() {
		...
		soundFile = UiTestUtils.saveFileToProject(UiTestUtils.DEFAULT_TEST_PROJECT_NAME, "longsound.mp3",
				org.catrobat.catroid.test.R.raw.longsound, getInstrumentation().getContext(), UiTestUtils.FileTypes.SOUND);
		SoundInfo soundInfo = new SoundInfo();
		soundInfo.setSoundFileName(soundFile.getName());
		soundInfo.setTitle(soundName);

		soundFile2 = UiTestUtils.saveFileToProject(UiTestUtils.DEFAULT_TEST_PROJECT_NAME, "testsoundui.mp3",
				org.catrobat.catroid.test.R.raw.testsoundui, getInstrumentation().getContext(), UiTestUtils.FileTypes.SOUND);
