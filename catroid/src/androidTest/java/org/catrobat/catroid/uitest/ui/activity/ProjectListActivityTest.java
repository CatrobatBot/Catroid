...
public class ProjectListActivityTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
	...
	private static final String TAG = ProjectListActivityTest.class.getSimpleName();
...
//		}
	...
	public void testOrientation() throws NameNotFoundException {
		...
		assertEquals("ProjectListActivity not in Portrait mode!", Configuration.ORIENTATION_PORTRAIT, solo
		...
		assertEquals(ProjectListActivity.class.getSimpleName()
	...
	public void testImageCache() {
		...
		//leave and reenter ProjectListActivity
		solo.goBack();
		solo.sleep(500);
		solo.clickOnButton(solo.getString(R.string.main_menu_programs));
		solo.waitForActivity(ProjectListActivity.class.getSimpleName());
	...
	public void testRenameToSameName() {
		...
		solo.sendKey(Solo.ENTER);
		solo.sleep(200);
		solo.assertCurrentActivity("Should be My Projects Activity", ProjectListActivity.class);
