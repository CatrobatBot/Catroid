...
public class PhiroMoveMotorForwardBrickTest extends BaseActivityInstrumentationTestCase<ScriptActivity> {
    private static final int SET_SPEED = 30;
    private static final int SET_SPEED_INITIALLY = -70;

    private Project project;
    private PhiroMotorMoveForwardBrick motorBrick;

    public PhiroMoveMotorForwardBrickTest() {
    ...
    public void testPhiroMotorActionBrick() {
        ...
        assertNotNull("TextView does not exist.", solo.getText(solo.getString(R.string.brick_phiro_motor_forward_action)));
        assertNotNull("TextView does not exist.", solo.getText(solo.getString(R.string.phiro_motor_speed)));

        UiTestUtils.testBrickWithFormulaEditor(solo, ProjectManager.getInstance().getCurrentSprite(),
                R.id.brick_phiro_motor_forward_action_speed_edit_text, SET_SPEED, Brick.BrickField.PHIRO_SPEED, motorBrick);
    ...
    private void createProject() {
        ...
        motorBrick = new PhiroMotorMoveForwardBrick(PhiroMotorMoveForwardBrick.Motor.MOTOR_RIGHT, SET_SPEED_INITIALLY);
